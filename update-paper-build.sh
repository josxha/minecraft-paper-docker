...
docker build . \
  --tag josxha/minecraft-paper:$latestMinecraftVersion-$latestPaperBuild \
  --tag josxha/minecraft-paper:$latestMinecraftVersion \
...
docker push josxha/minecraft-paper:latest